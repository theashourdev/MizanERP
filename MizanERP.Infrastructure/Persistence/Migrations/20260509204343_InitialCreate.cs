        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity_Unit = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Cost_Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Cost_Currency = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RawMaterialProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Quantity_Value = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Quantity_Unit = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
